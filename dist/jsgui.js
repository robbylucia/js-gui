...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "link", function() { return src_link_0; });
...
const src_link_0 = (url, element, attr = {}) => {
  attr.href = url;
...
let ul = (listItems, attr = {}) => {
  ...
  listItems.forEach((listItem) => {
    src_append(list, el("li", attr, listItem))
  })
  return list;
}
...
let demo = () => {
  src_add(h5("jsgui debug v0.3.1: " + Math.round(Math.random() * 100), { style: "box-shadow: 0 0 100px 0px #b9d854; position: fixed; top: 0; right: 0; padding: 0.5em; background: #282828; color: #BADA55" }))
